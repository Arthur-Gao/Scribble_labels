...
class LaserScan:
  ...
  def set_points(self, points, remissions=None):
    ...
    if self.project and self.label_filter is None:
...
class SemLaserScan(LaserScan):
  ...
  def __init__(self, nclasses, sem_color_dict=None, project=False, H=64, W=1024, fov_up=3.0, fov_down=-25.0, label_filter=None):
    ...
    # filter point of selected classes
    self.label_filter = np.asarray(label_filter) if label_filter else None
